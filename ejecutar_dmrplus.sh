...
sudo sed -i "10c Name[es_ES]=ON/OFF" /home/pi/Abrir_MMDVMPLUS.desktop
...
xterm -geometry 85x13+612+846 -bg black -fg white -fa ‘verdana’ -fs 9x -T CONSOLA_DMR+ -e sudo ./MMDVMPLUS MMDVMPLUS.ini
