...
<div class="row"> 
                <div class="col-md-12 text-center">
                   ...
                   <span class="color_font_Bebas_blanca">  &nbsp;IMAGEN-A111</span><br><br>
                </div>
</div><!-- row -->
<!-- ============================================================================================= -->
<!-- <div class="row">   
<div  class="col-md-4 text-center"></div>
   <div  class="col-md-4 text-center">  
      <a href="editor_password.php" class="btn btn-warning">CAMBIAR PASSWORD PARA ENTRAR A ESTE PANEL</a>
   </div>
</div> --><!-- row -->
...
<div class="col-md-4"></div>     
            <div class="col-md-4 text-center thumbnail"><br>
                  <img src="imagenes/DASHBOARD.png" width="295" ></img><br>
                  <a href="/dashboard/dashboard_embebido.php" class="btn btn-success btn-sm">ABRIR DASHBOARD </a>
            </div>
