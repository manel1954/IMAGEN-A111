...
sed -i "4c Exec=sh -c 'cd /home/pi/$SCRIPTS_version; sh cerrar_radio.sh'" /home/pi/Abrir_Radio.desktop
...
xterm -geometry 85x13+1215+846 -bg blue -fg white -fa ‘verdana’ -fs 9x -T CONSOLA_RADIO -e sudo ./MMDVMHost MMDVM.ini
